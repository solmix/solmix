...
public class EMFProviderAM implements EMFProvider
{
    ...
    * {@inheritDoc}
    * 
    * @see org.solmix.jpa.EMFProvider#getEntityManagerFactory()
    */
   @Override
    ...
    * {@inheritDoc}
    * 
    * @see org.solmix.jpa.EMFProvider#getEntityManager()
    */
   @Override
    ...
    * {@inheritDoc}
    * 
    * @see org.solmix.jpa.EMFProvider#returnEntityManager(javax.persistence.EntityManager)
    */
   @Override
    ...
    * {@inheritDoc}
    * 
    * @see org.solmix.jpa.EMFProvider#getTransaction(javax.persistence.EntityManager)
    */
   @Override
    ...
    * {@inheritDoc}
    * 
    * @see org.solmix.jpa.EMFProvider#commitTansaction(java.lang.Object)
    */
   @Override
    ...
    * {@inheritDoc}
    * 
    * @see org.solmix.jpa.EMFProvider#rollbackTransaction(java.lang.Object)
    */
   @Override
