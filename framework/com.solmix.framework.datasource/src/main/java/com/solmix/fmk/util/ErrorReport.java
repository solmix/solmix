...
public class ErrorReport extends LinkedMap implements Serializable
{
    ...
    * @throws SlxException
    * 
    * @see com.solmix.api.datasource.IErrorReport#addError(java.lang.String, java.lang.String, java.lang.String)
    */
    ...
    * {@inheritDoc}
    * 
    * @see com.solmix.api.datasource.IErrorReport#getErrors(java.lang.String)
    */
