...
public abstract class AbstractJavaGenerator extends AbstractGenerator
{
    ...
    public String getRootClass() {
        String rootClass = introspectedTable.getTableInfoProperty(PropertyRegistry.ANY_ROOT_CLASS);
        if (rootClass == null) {
            Properties properties = domain.getJavaModelGeneratorInfo().getProperties();
