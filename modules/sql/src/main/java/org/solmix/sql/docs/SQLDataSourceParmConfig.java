...
<table border="0" cellpadding="1" cellspacing="1">
      <tbody>
            ...
            <tr>
                  ...
                  <td>String</td>
                  <td>指明获得数据源的接口类型:
                  <p>{@link org.solmix.sql.EInterfaceType#DATASOURCE}</p>

                  <p>{@link org.solmix.sql.EInterfaceType#DRIVERMANAGER}</p>

                  <p>{@link org.solmix.sql.EInterfaceType#JNDI}</p>

                  <p>{@link org.solmix.sql.EInterfaceType#JNDIOSGI}</p>

                  <p>{@link org.solmix.sql.EInterfaceType#OSGI}</p>
                  </td>
            </tr>
            <tr>
                  <td>database.type</td>
            ...
            <tr>
                  <td>jndiosgi</td>
                  <td>String</td>
                  <td>当interface.type设置为{@link org.solmix.sql.EInterfaceType#JNDIOSGI}时使用，指明数据库连接的url，例如：&nbsp;(osgi.jndi.service.name=jdbc/NoTxOracleDataSource)</td>
                  <td>OSGI+JNDI集成</td>
            </tr>
            <tr>
                  <td>osgi</td>
                  <td>String</td>
                  <td>当interface.type设置为{@link org.solmix.sql.EInterfaceType#OSGI}时使用，指明数据库连接的url.</td>
                  <td>OSGI</td>
            </tr>
            <tr>
                  <td>jndi</td>
                  <td>String</td>
                  <td>当interface.type设置为{@link org.solmix.sql.EInterfaceType#JNDI}时使用，指明数据库连接的url.例如：&nbsp;jdbc/RCCEEI2</td>
                  <td>JNDI查找的数据源</td>
            </tr>
            <tr>
                  <td>driver</td>
                  <td>String</td>
                  <td>当interface.type设置为{@link org.solmix.sql.EInterfaceType#DRIVERMANAGER}和<span style="background-color: rgb(249, 252, 252);">{@link org.solmix.sql.EInterfaceType#DATASOURCE}</span>时使用,为<span style="background-color: rgb(249, 252, 252);">DRIVERMANAGER时代表</span>数据库驱动，例如：&nbsp;oracle.jdbc.driver.OracleDriver，为<span style="background-color: rgb(249, 252, 252);">DATASOURCE为数据库默认的数据源，例如：oracle.jdbc.pool.</span><span style="background-color: rgb(249, 252, 252);">OracleDataSource</span></td>
