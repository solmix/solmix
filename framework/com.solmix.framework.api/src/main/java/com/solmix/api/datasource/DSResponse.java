...
public interface DSResponse extends ResponseType
{
    ...
    /**
     * get the record form {@link com.solmix.api.data.DSResponseData#getData() getData()} and filter data by
     * {@link com.solmix.api.datasource.DataSource#getProperties(Object)} if need original data ,use
