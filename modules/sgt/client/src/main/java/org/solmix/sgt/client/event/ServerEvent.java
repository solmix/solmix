...
public class ServerEvent extends JsObject implements Serializable
{

    private static final long serialVersionUID = -1678651569931690467L;

    public ServerEvent(JavaScriptObject obj)
    {
        super(obj);
    }
    ...
    public ServerEvent withAttribute(String key, Object value) {
