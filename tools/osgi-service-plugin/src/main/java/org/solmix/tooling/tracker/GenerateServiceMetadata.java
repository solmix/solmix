 ...
 */
package org.solmix.tooling.tracker;
...
import org.solmix.commons.osgi.tracker.annotation.Managed;
import org.solmix.commons.osgi.tracker.annotation.ProvideService;
import org.solmix.commons.osgi.tracker.annotation.RequireService;
import org.solmix.commons.osgi.tracker.annotation.Services;
...
public class GenerateServiceMetadata extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        try {
            ...
            project.getProperties().setProperty("BNDExtension-Private-Package", "org.solmix.commons.osgi.tracker");
            project.getProperties().setProperty("BNDPrependExtension-Import-Package", "!org.solmix.commons.osgi.tracker.annotation");
