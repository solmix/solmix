...
import org.solmix.api.context.DataSourceManagerProvider;
...
public class SingleDSMProvider implements DataSourceManagerProvider
{
     ...
     * {@inheritDoc}
     * 
     * @see org.solmix.api.context.DataSourceManagerProvider#getDataSourceManager()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.solmix.api.context.DataSourceManagerProvider#release()
     */
    @Override
    public void release() {
