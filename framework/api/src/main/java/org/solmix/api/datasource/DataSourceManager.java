...
public interface DataSourceManager
{
    ...
    DSRequest createDSRequest(String dataSourceName, Eoperation opType, DSCall rpc);
    ...
    DSRequest createDSRequest(DataSource dataSourceName, Eoperation opType, DSCall rpc);
