...
public class Schedule {
    ...
    private Vector<ScheduledItem> schedule;     // The actual events being scheduled, sorted
                                 // by ascending nextTime in the item

    private Log log = LogFactory.getLog(Schedule.class);

    public Schedule(){
        this.schedule   = new Vector<ScheduledItem>();
        this.scheduleID = 0;
    }
    ...
    public synchronized List<Object> consumeNextItems() 
        throws EmptyScheduleException 
    {
        int size = this.schedule.size();
        ScheduledItem base;
    ...
    public static void main(String args[]) throws Exception {
        ...
        while(true){
            ...
            if(System.currentTimeMillis() > s.getTimeOfNext()){
                List<Object> items = s.consumeNextItems();
