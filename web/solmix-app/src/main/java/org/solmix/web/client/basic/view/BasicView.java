...
import org.solmix.web.client.basic.presenter.BasicPresenter.MyView;
...
public class BasicView extends ViewWithUiHandlers<BasicUiHandlers> implements MyView
{
    ...
    private String CONTENT_WIDTH = "100%";
    ...
    */
     ...
     * {@inheritDoc}
     * 
     * @see org.solmix.web.client.basic.presenter.BasicPresenter.MyView#init(org.solmix.web.shared.result.MenuConfigResult)
     */
    @Override
    public void init(MenuConfigResult result) {
...
//        menu.setID(bean.getId());
        ...
        menu.setWidth(Solmix.getConstants().default_menu_width());
...
//        menu.setAnimateRectTime(50);
     ...
     * {@inheritDoc}
     * 
     * @see org.solmix.web.client.basic.presenter.BasicPresenter.MyView#getMainTabSet()
     */
    @Override
