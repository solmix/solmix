...
import com.solmix.fmk.serialize.jackson.ResponseStatusSerializer;
import com.solmix.fmk.serialize.jackson.TdataSourceSerializer;
import com.solmix.fmk.serialize.jackson.TfieldsSerializer;
import com.solmix.fmk.serialize.jackson.ToperationBindingSerializer;
import com.solmix.fmk.serialize.jackson.ToperationBindingsSerializer;
import com.solmix.fmk.serialize.jackson.TvalidatorsSerializer;
import com.solmix.fmk.serialize.jackson.TvalueMapSerializer;
import com.solmix.fmk.util.SLXDate;
...
public class JacksonJSParserImpl implements JSParser
{
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.api.serialize.JSParser#getImplName()
     */
    @Override
    ...
    protected void _toIscJS(Writer out, Object obj) throws SlxException {
        if (obj instanceof TdataSource) {
            com.solmix.api.jaxb.ObjectFactory factory = new ObjectFactory();
    ...
    private synchronized ObjectMapper customConfig(ObjectMapper mapper, boolean isIsc) {
        ...
        if (isIsc) {
            ...
            module.addSerializer(com.solmix.api.jaxb.TdataSource.class, new TdataSourceSerializer());
            module.addSerializer(java.util.Date.class, new ContextualDateSerializer("new Date(", ")"));
            module.addSerializer(com.solmix.fmk.util.SLXDate.class, new ContextualDateSerializer("Date.parseServerDate(", ")", true));
            module.addSerializer(com.solmix.api.jaxb.TvalueMap.class, new TvalueMapSerializer());
            module.addSerializer(com.solmix.api.jaxb.Tvalidators.class, new TvalidatorsSerializer());
            module.addSerializer(com.solmix.api.jaxb.Tfields.class, new TfieldsSerializer());
            module.addSerializer(com.solmix.api.jaxb.Module.class, new ModuleSerializer());
            module.addSerializer(com.solmix.api.datasource.DSResponse.Status.class, new ResponseStatusSerializer());
            module.addSerializer(com.solmix.api.jaxb.ToperationBindings.class, new ToperationBindingsSerializer());
            module.addSerializer(com.solmix.api.jaxb.ToperationBinding.class, new ToperationBindingSerializer());
     ...
     * @throws SlxException
     * 
     * @see com.solmix.api.serialize.JSParser#toJavaObject(java.lang.String, java.lang.Class)
     */
    @Override
