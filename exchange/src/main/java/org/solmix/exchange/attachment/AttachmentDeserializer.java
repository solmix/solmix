...
public class AttachmentDeserializer {
    ...
    protected void initializeRootMessage() throws IOException {
        ...
        if (AttachmentUtils.isTypeSupported(contentType.toLowerCase(), supportedTypes)) {
            ...
            String val = AttachmentUtils.getHeader(ih, "Content-Type", "; ");
    ...
    public DefaultAttachment readNext() throws IOException {
        ...
        return (DefaultAttachment)createAttachment(headers);
    }
    ...
    private void cache(DelegatingInputStream input, boolean deleteOnClose) throws IOException {
        ...
        try{
            ...
            AttachmentUtils.setStreamedAttachmentProperties(message, out);
    ...
    private Attachment createAttachment(Map<String, List<String>> headers) throws IOException {
        InputStream partStream = 
            new DelegatingInputStream(new MimeBodyPartInputStream(stream, boundary, pbAmount),
                                      this);
        createCount++;
        return AttachmentUtils.createAttachment(partStream, headers);
    }
