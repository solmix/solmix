...
package com.solmix.fmk.internel;

import static com.solmix.commons.util.DataUtil.getBoolean;
import static com.solmix.commons.util.DataUtil.getInteger;
import static com.solmix.commons.util.DataUtil.getString;
...
public class DSConfigManager implements ManagedService, ConfigManager
{
    ...
    public static String slxVersionNumber = "SLX_WEB_CORE_SNAPHOST-2011-03-06";
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.api.cm.ConfigManager#updateConfig(java.util.Properties)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.api.cm.ConfigManager#getPid()
     */
    @Override
    public String getPid() {
        // TODO Auto-generated method stub
        return "com.solmix.framework.datasource";
    }
}
