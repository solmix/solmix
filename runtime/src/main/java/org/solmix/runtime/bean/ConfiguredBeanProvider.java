...
public interface ConfiguredBeanProvider {
    ...
    /**
     * Gets the names of all the configured extensions of the specific type.
     * Does not cause them to be loaded.
     * 
     * @param type
    ...
    public interface BeanLoaderListener<T> {
         ...
         * which point, the loader will stop loading additional extensions of
         * the given type
         * 
         * @param name
         * @param bean
