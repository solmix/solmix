...
import com.solmix.fmk.interfaces.ValidatorFunc;
...
public class DefaultValidators
{
    ...
    static class isBoolean implements ValidatorFunc
    {
         ...
         * {@inheritDoc}
         * 
         * @see com.solmix.fmk.util.DefaultValidators.ValidatorFunc#validate(java.util.Map, java.lang.Object,
         *      java.lang.String, java.util.Map, com.solmix.fmk.datasource.ValidationContext)
         */
        @Override
    ...
    static class serverCustom implements ValidatorFunc
    {
         ...
         * {@inheritDoc}
         * 
         * @see com.solmix.fmk.util.DefaultValidators.ValidatorFunc#validate(com.solmix.fmk.datasource.Validator,
         *      java.lang.Object, java.lang.String, java.util.Map, com.solmix.fmk.datasource.ValidationContext)
         */
        @Override
