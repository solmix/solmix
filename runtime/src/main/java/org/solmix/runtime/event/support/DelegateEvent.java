...
/**
 * Delegate Osgi {@link org.osgi.service.event.Event Event} to {@link org.solmix.runtime.event.IEvent IEvent}
...
public class DelegateEvent implements IEvent
{
   ...
   public DelegateEvent(Event event){
     ...
     * {@inheritDoc}
     * 
     * @see org.solmix.runtime.event.IEvent#getProperties()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.solmix.runtime.event.IEvent#getProperty(java.lang.String)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.solmix.runtime.event.IEvent#getTopic()
     */
    @Override
