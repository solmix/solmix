...
package com.solmix.launch.base.web;
...
import com.solmix.launch.base.internal.Solmix;
...
public class ServletDelegate extends GenericServlet implements Launcher
{
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.loaders.shared.Launcher#setSolmixHome(java.lang.String)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.loaders.shared.Launcher#setNotifiable(com.solmix.loaders.shared.Notifiable)
     */
    @Override
