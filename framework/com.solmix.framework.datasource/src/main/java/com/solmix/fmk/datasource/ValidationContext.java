...
import com.solmix.fmk.velocity.Util;
...
public class ValidationContext extends HashMap
{
    ...
    */
    ...
    public Map<String, Object> getClientErros() {
    ...
    private void createError(String fieldName, String newErrors) throws SlxException {
        createError(fieldName, newErrors, null);
    }

    private void createError(String fieldName, String newErrors, String suggest) throws SlxException {
        if (newErrors == null)
            return;
        if (errors == null)
        ...
        if (vevent != null) {
            ...
            DataUtil.putCombinedList(report, fieldName, vevent);
        }
    }
    ...
    /**
     * set by {@link com.solmix.fmk.datasource.ValidationContext#addPath(String)} or
     * {@link com.solmix.fmk.datasource.ValidationContext#removePathSegment()}
     * 
