...
public class HSQLDBDriver extends SQLDriver
{
    ...
    public HSQLDBDriver(String dbName, SQLTable table, DataTypeMap config, SQLDataSource ds) throws SlxException
    {
    ...
    public static SQLDriver instance(String dbName, SQLTable table, DataTypeMap config, SQLDataSource ds) throws SlxException {
        return new HSQLDBDriver(dbName, table, config, ds);
    }
