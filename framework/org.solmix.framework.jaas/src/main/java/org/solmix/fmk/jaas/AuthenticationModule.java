...
public class AuthenticationModule extends AbstractLoginModule
{
     ...
     * @throws SlxException 
     */
    public int getMaxAttempts() throws SlxException {
     ...
     * @throws SlxException 
     */
    public long getTimeLock() throws SlxException {
     ...
     * {@inheritDoc}
     * 
     * @see org.solmix.fmk.jaas.AbstractLoginModule#setEntity()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see org.solmix.fmk.jaas.AbstractLoginModule#setACL()
     */
    @Override
    public void setACL() {
        // NULL
