...
import static org.solmix.commons.util.SystemPropertyAction.getProperty;
...
public class SysInfoUtils
{
    ...
    public static final class JavaInfo {
        private final String  JAVA_VERSION       = getProperty("java.version");
        private final float   JAVA_VERSION_FLOAT = getJavaVersionAsFloat();
        private final int     JAVA_VERSION_INT   = getJavaVersionAsInt();
        private final String  JAVA_VENDOR        = getProperty("java.vendor");
        private final String  JAVA_VENDOR_URL    = getProperty("java.vendor.url");
    ...
    public static final class JavaRuntimeInfo {
        private final String JAVA_RUNTIME_NAME    = getProperty("java.runtime.name");
        private final String JAVA_RUNTIME_VERSION = getProperty("java.runtime.version");
        private final String JAVA_HOME            = getProperty("java.home");
        private final String JAVA_EXT_DIRS        = getProperty("java.ext.dirs");
        private final String JAVA_ENDORSED_DIRS   = getProperty("java.endorsed.dirs");
        private final String JAVA_CLASS_PATH      = getProperty("java.class.path");
        private final String JAVA_CLASS_VERSION   = getProperty("java.class.version");
        private final String JAVA_LIBRARY_PATH    = getProperty("java.library.path");
    ...
    public static final class JavaSpecInfo {
        private final String JAVA_SPECIFICATION_NAME    = getProperty("java.specification.name");
        private final String JAVA_SPECIFICATION_VERSION = getProperty("java.specification.version");
        private final String JAVA_SPECIFICATION_VENDOR  = getProperty("java.specification.vendor");
    ...
    public static final class JvmInfo {
        private final String JAVA_VM_NAME    = getProperty("java.vm.name");
        private final String JAVA_VM_VERSION = getProperty("java.vm.version");
        private final String JAVA_VM_VENDOR  = getProperty("java.vm.vendor");
        private final String JAVA_VM_INFO    = getProperty("java.vm.info");
    ...
    public static final class JvmSpecInfo {
        private final String JAVA_VM_SPECIFICATION_NAME    = getProperty("java.vm.specification.name");
        private final String JAVA_VM_SPECIFICATION_VERSION = getProperty("java.vm.specification.version");
        private final String JAVA_VM_SPECIFICATION_VENDOR  = getProperty("java.vm.specification.vendor");
    ...
    public static final class OsInfo {
        private final String  OS_VERSION         = getProperty("os.version");
        private final String  OS_ARCH            = getProperty("os.arch");
        ...
        private final String FILE_SEPARATOR = getProperty("file.separator");
        private final String LINE_SEPARATOR = getProperty("line.separator");
        private final String PATH_SEPARATOR = getProperty("path.separator");
    ...
    public static final class UserInfo {
        private final String USER_NAME      = getProperty("user.name");
        private final String USER_HOME      = getProperty("user.home");
        private final String USER_DIR       = getProperty("user.dir");
        private final String USER_LANGUAGE  = getProperty("user.language");
        private final String USER_COUNTRY   = getProperty("user.country") == null ? getProperty(
                "user.region") : getProperty("user.country");
        private final String JAVA_IO_TMPDIR = getProperty("java.io.tmpdir");
    ...
    private static void append(StringBuilder buffer, String caption, String value) {
        buffer.append(caption).append(ObjectUtils.defaultIfNull(value, "[n/a]")).append("\n");
    }
}
