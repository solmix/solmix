...
/**
 * Class that supports masking an entire {@link Canvas} and adds the possibility to display a message during masking and
 * a loading image
 * 
...
public class ModalWindow
{
    ...
    /**
     * Creates a new {@link ModalWindow} given the canvas to be masked (an {@link Canvas#addChild(Canvas)} will be
     ...
     * 
     * @param showLoading whether to show a box with a loading indicator above the background
     */
    ...
    /**
     * Mask the {@link Canvas} with a transparent color and display a message above it
     * 
     ...
     * <P>
     * Specify as the partial URL to an image, relative to the imgDir (by default "public/images/") of this component
     * 
     * @param loadingIcon icon URL of new image icon. Default value is <blockquote> " {@link Page#getSkinImgDir()}
     *        /loading.gif "
     */
    ...
    /**
     * The background color for the message/loading box. You can set this property to an RGB value (e.g. #22AAFF) or a
     * named color (e.g. red) from a list of browser supported color names.
     * 
     * @param backgroundColor new background color to set to the message/loading box. Default value is "#fff"
     */
