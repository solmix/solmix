...
import org.solmix.service.fdfs.exception.FdfsUnsupportStorePathException;
import org.solmix.service.fdfs.proto.OtherConstants;
import org.solmix.service.fdfs.proto.mapper.DynamicFieldType;
...
public class StorePath {
    ...
    public static StorePath praseFromUrl(String filePath) {
        Assert.assertNotNull(filePath, "解析文件路径不能为空");
        // 获取group起始位置
