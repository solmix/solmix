...
public class SpringEventManager implements EventManager, ApplicationContextAware
{
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.api.event.EventManager#postEvent(com.solmix.api.event.IEvent)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.api.event.EventManager#sendEvent(com.solmix.api.event.IEvent)
     */
    @Override
