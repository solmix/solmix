...
public class SpringContainerFactory extends ContainerFactory {
    ...
    public Container createContainer(String[] cfgFiles, boolean includeDefaults) {
        try {
            ...
            ConfigurableApplicationContext cac = createApplicationContext(
                cfgFiles, includeDefaults, parent);
    ...
    private ConfigurableApplicationContext createApplicationContext(
        String[] cfgFiles, boolean includeDefaults, ApplicationContext parent) {
        try {
            return new ContainerApplicationContext(cfgFiles, parent,
                includeDefaults);
        } catch (BeansException ex) {
