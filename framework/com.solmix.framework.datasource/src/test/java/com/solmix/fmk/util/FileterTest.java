...
import com.solmix.fmk.i18n.FilterEnumeration;
...
public class FileterTest
{
   ...
   public static void main(String[] args)
   {
      ...
      Enumeration e = new FilterEnumeration("CLASSPATH:/com/solmix/fmk/util", "*.class", false);
   ...
   {
      Enumeration e = new FilterEnumeration("CLASSPATH:/com/solmix/fmk/util", "FileterTest.class", false);
