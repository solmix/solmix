	...
	public static <T> T transform(Object value, Class<T> targetType) throws TransformException {
		...
		if ((value instanceof Map) && !targetType.isPrimitive() && !targetType.isInterface() && !targetType.isArray()) {
			try {
				...
				LOG.debug((new StringBuilder()).append("Tried to convert inbound nested Map to: ")
						.append(targetType.getName())
						.append(" but DataTools.setProperties() on instantiated class failed")
						.append(" with the following error: ").append(ee.getMessage()).toString());
			}
		}
		...
		if (!targetType.isPrimitive() && (targetType.isInterface() || Modifier.isAbstract(targetType.getModifiers())))
			LOG.warn((new StringBuilder()).append("Impossible to convert to target type ").append(targetType.getName())
					.append(" - it is not a concrete class").toString());
		throw new TransformException((new StringBuilder()).append("Can't convert value of type ")
				.append(value.getClass().getName()).append(" to target type ").append(targetType.getName()).toString());
	...
	static {
			...
			public Byte transform(Object value) throws TransformException {
				...
				if (java.lang.String.class.isAssignableFrom(valueClass)) {
					try {
						...
						throw new TransformException((new StringBuilder()).append("Value '").append(value.toString())
								.append("' of type '").append(valueClass.toString())
								.append("' can not be casted to type java.lang.Byte.'").toString());
					}
				}
				String value1 = value.toString();
				if ("".equals(value1))
				...
				if (java.lang.String.class.isAssignableFrom(valueClass)) {
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(Short.class.toString()).append("'.").toString());
					}
				}
				String value1 = value.toString();
				if ("".equals(value))
				...
				if (java.lang.String.class.isAssignableFrom(valueClass))
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(Integer.class.toString()).append("'.").toString());
					}
				...
				if (java.lang.String.class.isAssignableFrom(valueClass))
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(Long.class.toString()).append("'.").toString());
					}
				if (java.util.Date.class.isAssignableFrom(valueClass))
					return Long.valueOf(((Date) value).getTime());
				if (java.util.Collection.class.isAssignableFrom(valueClass) && ((Collection<?>) value).isEmpty()) {
					return null;
				}
				String value1 = value.toString();
				if ("".equals(value1))
				...
				if (java.lang.String.class.isAssignableFrom(valueClass))
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(Float.class.toString()).append("'.").toString());
					}
				if (java.util.Date.class.isAssignableFrom(valueClass))
				...
				if (java.lang.String.class.isAssignableFrom(valueClass))
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(Double.class.toString()).append("'.").toString());
					}
				if (java.util.Date.class.isAssignableFrom(valueClass))
				...
				if (java.lang.String.class.isAssignableFrom(valueClass))
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(BigDecimal.class.toString()).append("'.").toString());
					}
				if (java.util.Date.class.isAssignableFrom(valueClass))
				...
				if (java.lang.String.class.isAssignableFrom(valueClass))
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(BigInteger.class.toString()).append("'.").toString());
					}
				if (java.util.Date.class.isAssignableFrom(valueClass))
		...
		Transformer<Object, java.sql.Date> javaSqlDateTransform = new Transformer<Object, java.sql.Date>() {
			...
			public java.sql.Date transform(Object value) throws TransformException {
				...
				if (java.lang.String.class.isAssignableFrom(valueClass)) {
					...
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(java.sql.Date.class.toString()).append("'.").toString());
					}
				}
				if (java.util.Date.class.isAssignableFrom(valueClass))
				...
				throw new TransformException((new StringBuilder()).append("Can't covert type: ")
						.append(java.sql.Date.class.getName()).append(" to java.sql.Date").toString());
			}
		...
		Transformer<Object, java.sql.Time> javaSqlTimeTransform = new Transformer<Object, java.sql.Time>() {
			...
			public java.sql.Time transform(Object value) throws TransformException {
				...
				if (java.lang.String.class.isAssignableFrom(valueClass)) {
					...
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(java.sql.Time.class.toString()).append("'.").toString());
					}
				}
				if (java.util.Date.class.isAssignableFrom(valueClass))
				...
				throw new TransformException((new StringBuilder()).append("Can't covert type: ")
						.append(java.sql.Time.class.getName()).append(" to java.sql.Time").toString());
			}
		...
		Transformer<Object, java.sql.Timestamp> javaSqlTimestampTransform = new Transformer<Object, java.sql.Timestamp>() {
			...
			public java.sql.Timestamp transform(Object value) throws TransformException {
				...
				if (java.lang.String.class.isAssignableFrom(valueClass)) {
					...
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(java.sql.Timestamp.class.toString()).append("'.").toString());
					}
				}
				if (java.util.Date.class.isAssignableFrom(valueClass))
				...
				throw new TransformException((new StringBuilder()).append("Can't covert type: ")
						.append(java.sql.Timestamp.class.getName()).append(" to java.sql.Timestamp").toString());
			}
				...
				if (java.lang.String.class.isAssignableFrom(valueClass)) {
					...
					try {
						...
						throw new TransformException(
								(new StringBuilder()).append("Value '").append(value.toString()).append("' of type '")
										.append(valueClass.toString()).append("' can not be casted to type '")
										.append(Date.class.toString()).append("'.").toString());
					}
				}
				throw new TransformException((new StringBuilder()).append("Can't covert type: ")
						.append(Date.class.getName()).append(" to java.sql.Timestamp").toString());
			}
		...
		Transformer<Object, Map<String, Object>> mapTransform = new Transformer<Object, Map<String, Object>>() {
			...
			public Map<String, Object> transform(Object input) throws TransformException {
				...
				if (input instanceof Map<?, ?>)
				...
				else if (!targetType.isPrimitive() && !targetType.isInterface() && !targetType.isArray()
						&& !targetType.isAnnotation() && !targetType.isEnum()) {
					try {
					...
					throw new TransformException((new StringBuilder()).append("Can't covert type: ")
							.append(input.getClass().getName()).append(" to java.util.Map").toString());
				}
			}
