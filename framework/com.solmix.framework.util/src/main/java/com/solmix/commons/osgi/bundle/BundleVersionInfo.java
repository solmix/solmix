...
package com.solmix.commons.osgi.bundle;
...
public class BundleVersionInfo extends VersionInfo<File>
{
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.launch.shared.internal.bundle.VersionInfo#getSource()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.launch.shared.internal.bundle.VersionInfo#isBundle()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.launch.shared.internal.bundle.VersionInfo#getBundleSymbolicName()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.launch.shared.internal.bundle.VersionInfo#getVersion()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.launch.shared.internal.bundle.VersionInfo#isSnapshot()
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see com.solmix.launch.shared.internal.bundle.VersionInfo#getBundleLastModified()
     */
    @Override
