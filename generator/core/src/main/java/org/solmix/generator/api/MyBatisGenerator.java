 ...
 * 
 * <ol>
 * <li>Create a ConfigurationInfo object. The ConfigurationInfo can be the result of a parsing the XML configuration file, or it
...
public class MyBatisGenerator {
     ...
     * @throws InvalidConfigurationInfoException
     *             if the specified configuration is invalid
     */
    public MyBatisGenerator(ConfigurationInfo configuration, ShellCallback shellCallback,
