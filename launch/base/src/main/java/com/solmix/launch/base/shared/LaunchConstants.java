...
public class LaunchConstants
{
    ...
    public static String LOADERS_PATH = "com.solmix.launch.base";

    public static String JAAS_PATH_LOADER = "jaas-boot";

    public static final String LOADER_JAR_REL_PATH = "com.solmix.launch.base.jar";
    ...
    public static String DEFAULT_SOLMIX_SERVLET = "com.solmix.launch.base.web.ServletDelegate";

    public static String DEFAULT_DELEGATE_CLASS = "com.solmix.launch.base.web.HttpSessionListenerDelegate";
