...
public class MimeMessageHelper
{
    ...
    public void setFrom(InternetAddress from) throws MessagingException {
          Assert.isNotNull(from, "From address must not be null");
    ...
    public void setReplyTo(InternetAddress replyTo) throws MessagingException {
          Assert.isNotNull(replyTo, "Reply-to address must not be null");
    ...
    public void setTo(InternetAddress to) throws MessagingException {
          Assert.isNotNull(to, "To address must not be null");
          validateAddress(to);
          this.mimeMessage.setRecipient(Message.RecipientType.TO, to);
    }

    public void setTo(InternetAddress[] to) throws MessagingException {
          Assert.isNotNull(to, "To address array must not be null");
    ...
    public void setCc(InternetAddress cc) throws MessagingException {
          Assert.isNotNull(cc, "Cc address must not be null");
          validateAddress(cc);
          this.mimeMessage.setRecipient(Message.RecipientType.CC, cc);
    }

    public void setCc(InternetAddress[] cc) throws MessagingException {
          Assert.isNotNull(cc, "Cc address array must not be null");
    ...
    public void setBcc(InternetAddress bcc) throws MessagingException {
          Assert.isNotNull(bcc, "Bcc address must not be null");
          validateAddress(bcc);
          this.mimeMessage.setRecipient(Message.RecipientType.BCC, bcc);
    }

    public void setBcc(InternetAddress[] bcc) throws MessagingException {
          Assert.isNotNull(bcc, "Bcc address array must not be null");
    ...
    public void setSentDate(Date sentDate) throws MessagingException {
          Assert.isNotNull(sentDate, "Sent date must not be null");
    ...
    public void setSubject(String subject) throws MessagingException {
          Assert.isNotNull(subject, "Subject must not be null");
          if (getEncoding() != null) {
    ...
    public void setText(String plainText, String htmlText) throws MessagingException {
          Assert.isNotNull(plainText, "Plain text must not be null");
          Assert.isNotNull(htmlText, "HTML text must not be null");
    ...
    public void addInline(String contentId, DataSource dataSource) throws MessagingException {
          Assert.isNotNull(contentId, "Content ID must not be null");
          Assert.isNotNull(dataSource, "DataSource must not be null");
          MimeBodyPart mimeBodyPart = new MimeBodyPart();
     ...
     * @see #addInline(String, javax.activation.DataSource)
     */
    public void addInline(String contentId, InputStreamResource resource) throws MessagingException {
     ...
     * @see #addInline(String, javax.activation.DataSource)
     */
    public void addInline(String contentId, InputStreamResource inputStreamSource, String contentType)
        throws MessagingException {

          Assert.isNotNull(inputStreamSource, "InputStreamSource must not be null");
    ...
    public void addAttachment(String attachmentFilename, DataSource dataSource) throws MessagingException {
          Assert.isNotNull(attachmentFilename, "Attachment filename must not be null");
          Assert.isNotNull(dataSource, "DataSource must not be null");
          MimeBodyPart mimeBodyPart = new MimeBodyPart();
     ...
     */
    public void addAttachment(String attachmentFilename, InputStreamResource inputStreamSource)
        throws MessagingException {
    ...
    public void addAttachment(
                String attachmentFilename, InputStreamResource inputStreamSource, String contentType)
        throws MessagingException {
    ...
    protected DataSource createDataSource(
        final InputStreamResource inputStreamSource, final String contentType, final String name) {
