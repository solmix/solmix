...
public interface UrlPattern extends Serializable
{
    ...
    public static final class MatchAllPattern implements UrlPattern
    {
        ...
        /**
         * @see com.solmix.commons.util.magnolia.cms.util.UrlPattern#match(java.lang.String)
         */
        @Override
        ...
        /**
         * @see com.solmix.commons.util.magnolia.cms.util.UrlPattern#getLength()
         */
        @Override
        ...
        /**
         * @see com.solmix.commons.util.magnolia.cms.util.UrlPattern#getString()
         */
        @Override
