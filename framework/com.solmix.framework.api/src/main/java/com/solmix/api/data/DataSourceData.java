 ...
 * variable.
 * <p>
 * <h1>Merge Specification</h1> {@link com.solmix.api.data.DataSourceData DataSourceData} and
 * {@link com.solmix.api.jaxb.TdataSource TdataSource} Merge Specification
 * <table border=1 >
 * <tr>
 ...
 * </tr>
 * </table>
 * For <code>From top to bottom<code>:use {@link com.solmix.api.data.DataSourceData DataSourceData}
 * <p>
 * For <code>From bottom to top<code>:use {@link com.solmix.api.jaxb.TdataSource TdataSource}
 * 
 * @author solomon
 * @since 0.0.1
...
public class DataSourceData implements Serializable
{
    ...
    */
    ...
    /**
     * The source of superDSName is form {@link com.solmix.api.jaxb.TdataSource}.
     * 
    ...
    /**
     * The source of superDSName is form {@link com.solmix.api.jaxb.TdataSource},so the <code>set</code> method should
     ...
     * {@link com.solmix.api.jaxb.TdataSource#getID()}
     * <p>
     * <B>
     * <li>ANNOTATE:</B>
     * <p>
     * This accessor method returns a reference to the <B>group:</B>{@link com.solmix.api.jaxb.TdataSource#getID() ID},
     ...
     * <B><li>ANNOTATE:</B>
     * <p>
     * This accessor method returns a reference to the {@link com.solmix.api.jaxb.TdataSource}, not a snapshot.
