...
import org.solmix.generator.internal.rules.Rules;
...
public abstract class IntrospectedTable {
    ...
    public void initialize() {
        ...
        domain.getPlugins().initialized(this);
    }
    ...
    protected String calculateJavaClientImplementationPackage() {
        JavaClientGeneratorInfo config = domain
    ...
    public boolean isImmutable() {
        ...
        return DataUtils.asBoolean(properties.getProperty(PropertyRegistry.ANY_IMMUTABLE));
    }
    ...
    public boolean isConstructorBased() {
        ...
        return DataUtils.asBoolean(properties.getProperty(PropertyRegistry.ANY_CONSTRUCTOR_BASED));
    }
