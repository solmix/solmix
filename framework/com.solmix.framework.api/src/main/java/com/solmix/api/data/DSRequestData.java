...
public class DSRequestData implements java.io.Serializable
{
    ...
    /**
     * {@link com.solmix.api.data.DSRequestData#criteria criteria} maybe <code>Map</code> or List &lt Map &gt
     * 
     * @return the criteria
     */
     ...
     * {@link com.solmix.api.context.Context}
     * 
    ...
    */
    ...
    /**
     * Convenience for get {@link com.solmix.api.data.DSRequestData#getRawOldValues()}.get <code>rawOldValues</code> as
     * a <code>Map</code>
     * 
     * @return
     */
    ...
    /**
     * get {@link com.solmix.api.data.DSRequestData#getRawCriteria()} as a <code>Map</code>
     * <p>
     * if {@link com.solmix.api.data.DSRequestData#getOperationType() OperationType} is
     * {@link com.solmix.api.jaxb.Eoperation.ADD ADD} the criteria is from
     * {@link com.solmix.api.data.DSRequestData#getValues()} if the OperationType is
     * {@link com.solmix.api.jaxb.Eoperation.UPDATE UPDATE} and {@link #getRawCriteria()} is null ,return
     * {@link #getValues()}
     * 
     * @return
     */
    ...
    /**
     * get {@link com.solmix.api.data.DSRequestData#getRawCriteria()} as a <code>List</code>
     * 
     * @return
     */
    ...
    /**
     * get {@link com.solmix.api.data.DSRequestData#getValues()} as a <code>Map</code>
     * <p>
     * If {@link com.solmix.api.data.DSRequestData#getOperationType() OperationType} is
     * {@link com.solmix.api.jaxb.Eoperation.FETCH FETCH} or {@link com.solmix.api.jaxb.Eoperation.REMOVE REMOVE} return
     * {@link com.solmix.api.data.DSRequestData#getCriteria()} else return
     * {@link com.solmix.api.data.DSRequestData#getRawValues() RawValues}
     * 
     * @return
     */
    ...
    /**
     * get {@link com.solmix.api.data.DSRequestData#getValues()} as a <code>List</code>
     * 
     * @return
     */
