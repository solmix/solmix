...
package org.solmix.eventservice.distribute;
...
public class DistributedEventAdmin implements EventAdmin
{
    ...
    public void sendEvent(Event arg0) {
        // Distribute EventAdmin not handle the Synchronous sendEvent.
        return;
